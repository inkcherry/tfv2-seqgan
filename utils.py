...
# import  tensorflow.keras.utils.np_utils.to_categorical
...
class GeneratorPretrainingGenerator(keras.utils.Sequence):
    '''
    ...
    def __getitem__(self, idx):
        ...
        y_true = keras.utils.to_categorical(y_true, num_classes=self.V)
...
class DiscriminatorGenerator(keras.utils.Sequence):
    '''
    Generate generator pretraining data.
    # Arguments
